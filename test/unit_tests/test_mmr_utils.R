...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmr_all.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmr_age_20-24.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmr_age_over50.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmratio_ethnicity_other.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmrate_age_45-49.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmratio_age_capemay_2017.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmratio_age_bergen_2017.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmratio_ethnicity_cumberland_2010.RDS")
  )
)
...
test_that(
  ...
  expect_equal(
    ...
    read_rds("./test/test_data/mmr_utils_test/mmrate_age_bergen_2017.RDS")
  )
)
