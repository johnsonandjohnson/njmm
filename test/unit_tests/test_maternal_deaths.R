...
validated_file_names <- unlist(map(age_groups, ~ paste0("Maternal Deaths 2005-2017 ", .x, ".xlsx")))
...
test_extract_attribute_age_groups <- extract_attribute_groups(validated_file_names)
